      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm">JOBHUNT© 2025 Your Company. All rights reserved for ©Nitharshan</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://www.facebook.com/share/1Gdn8e2z5t/?mibextid=wwXIfr" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://www.linkedin.com/in/thiyagaraj-nitharshan-21706133b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" className="hover:text-gray-400" aria-label="LinkedIn">
